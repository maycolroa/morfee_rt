                    ...
                    <div class="panel panel-default card-view border">
                        <div class="panel-heading">
                            <div class="d-flex justify-content-between">
                                <h6 class="panel-title txt-dark">ESTRUCTURA DE LA BASE DE DATOS DE AUTORIZACIONES</h6>
                                <div>
                    ...
                    <div class="panel panel-default card-view border">
                        ...
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body row pa-0">
                                <!-- TABLA 1 -->
                                <mng-time ref="xtime" :coleccion="'retec_autorizacion_' + indice" :alias="'time_autorizacion_' + indice"></mng-time>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="panel panel-default card-view border">
                                ...
                                <div class="panel-wrapper collapse in">
                                    <div :class="status == state.LOADING? 'panel-body opaco': 'panel-body'">
                                        <table-data :class="altCss(display == 'table')" ref="table_1" cols="_id:PLAN,total:REGISTROS" compact lastright sumar="total"></table-data>
                            ...
                            <div class="panel panel-default card-view border">
                                <div class="panel-heading border-bottomx">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="panel-title txt-dark force-cap">Tipo de usuario <i class="fa fa-spin fa-spinner ms-2" v-if="status == state.LOADING"></i></h6>
                                        <div>
                                            <a href="#" class="full-screen"><i class="zmdi zmdi-fullscreen"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-wrapper collapse in">
                                    <div :class="status == state.LOADING? 'panel-body opaco': 'panel-body'">
                                        <table-data :class="altCss(display == 'table')" ref="table_2" cols="_id:TIPO DOC,total:REGISTROS" compact lastright sumar="total"></table-data>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default card-view border">
                                ...
                                <div class="panel-wrapper collapse in">
                                    <div :class="status == state.LOADING? 'panel-body opaco': 'panel-body'">
                                        <table-data :class="altCss(display == 'table')" ref="table_3" cols="_id:ÁMBITO,total:REGISTROS" compact lastright sumar="total"></table-data>
                            ...
                            <div class="panel panel-default card-view border">
                                ...
                                <div class="panel-wrapper collapse in">
                                    <div :class="status == state.LOADING? 'panel-body opaco': 'panel-body'">
                                        <table-data :class="altCss(display == 'table')" ref="table_4" cols="_id:ESTADO,total:REGISTROS" compact lastright sumar="total"></table-data>
        ...
        <div :class="showCss('section', 'money')">
            <div class="alert alert-warning">
                <div class="d-flex">
                    ...
                    <div><b class="me-2" style="font-weight:bold">Sección en construcción:</b> Autorizaciones!</div>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    data() {
        return {
            ...
            campos: ['tpp', 'idp', 'nmp', 'pla', 'idc', 'tus', 'ius', 'iau', 'fau', 'amb', 'ids', 'ser', 'dia', 'can', 'est', 'vun', 'vbs', 'vac', 'vpm', 'pmx', 'pac'],
            pairs: {_id:'TOTAL REGISTROS', tpp:'TIPOIDPRESTADOR', idp:'IDPRESTADOR', nmp:'NOMBREPRESTADOR', pla:'PLANSALUD', idc:'IDCONTRATO', tus:'TIPOIDUSUARIO', ius:'IDUSUARIO', iau:'IDAUTORIZACION', fau:'FAUTO', amb:'AMBITO', ids:'IDSERVICIO', ser:'DESSERVICIO', dia:'DIAGPPAL', can:'CANT', est:'EST', vun:'VRUNIDAD', vbs:'VLRRESERVAPBS', vac:'VLRRESERVAPAC', vpm:'VLRRESERVAPM', pmx:'PRES_MAX', pac:'PACT'},
            lc_token: '',
            tokens: {},
    ...
    methods: {
        ...
        changeDisplay: function(arg){
            this.display = arg;
            localStorage.setItem('display_aut', arg);
        },
        ...
        loadFacetCandidate: function(arg){
            ...
            //          Plan salud          Tipo de usuario     Ámbito              Est
            var gra = ["rs_1:group:pla:1", "rs_2:group:tus:1", "rs_3:group:amb:1", "rs_4:group:est:1"];
            var gre = ["rs_1:crx:" + crx, "rs_2:crx:" + crx, "rs_3:crx:" + crx, "rs_4:crx:" + crx];
            var pam = new FormData();
            pam.append('tema', this.coleccion);
            ...
            axios.post(root_path + 'reservas/mng/facet', pam).then(res => {
                this.rawData = (res.data.length > 0)?  res.data[0]: {'rs_1': [], 'rs_2': [], 'rs_3': [], 'rs_4': []};
                this.writeCards();
    ...
    mounted() {
        this.lc_token = this.makeToken();
        this.display = (localStorage.getItem('display_aut') == null)? 'table': localStorage.getItem('display_aut');
        this.listen();
        this.coleccion = 'retec_autorizacion_' + this.indice;
        this.key_history = 'dash_autorizacion_' + this.indice;
