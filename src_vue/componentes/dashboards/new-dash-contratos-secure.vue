<template>
    <div :class="'component-' + status">
        ...
        <div :class="['basic', 'general'].includes(section)? '': 'd-none'">
            <div class="row">
                <div class="col-sm-3">
                    <local-counter ref="contador_1" class="border" texto="REGISTROS ISAÍAS" valor="0" duracion="1" miles></local-counter>
                </div>
