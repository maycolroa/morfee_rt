                    ...
                    <div class="panel panel-default card-view border">
                        <div class="panel-heading">
                            <div class="d-flex justify-content-between">
                                <h6 class="panel-title txt-dark">ESTRUCTURA DE LA BASE DE DATOS DE FACTURAS</h6>
                                <div>
                    ...
                    <div class="panel panel-default card-view border">
                        ...
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body row pa-0">
                                <!-- TABLA 1 -->
                                <mng-time ref="xtime" :coleccion="'retec_facturas_' + indice" :alias="'time_factura_' + indice"></mng-time>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="panel panel-default card-view border">
                                <div class="panel-heading border-bottomx">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="panel-title txt-dark">Est Glosa <i class="fa fa-spin fa-spinner ms-2" v-if="status == state.LOADING"></i></h6>
                                        <div>
                                            <a href="#" class="full-screen"><i class="zmdi zmdi-fullscreen"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-wrapper collapse in">
                                    <div :class="status == state.LOADING? 'panel-body opaco': 'panel-body'">
                                        <table-data :class="altCss(display == 'table')" ref="table_4" cols="_id:ESTGLOSA,total:REGISTROS" compact lastright sumar="total"></table-data>
        ...
        <div :class="showCss('section', 'money')">
            <div class="alert alert-warning">
                <div class="d-flex">
                    ...
                    <div><b class="me-2" style="font-weight:bold">Sección en construcción:</b> Facturas!</div>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        changeDisplay: function(arg){
            this.display = arg;
            localStorage.setItem('display_fac', arg);
        },
        ...
        loadFacetCandidate: function(arg){
            ...
            //          Plan salud          TContra              Ámbito              Tipo Obligación
            var gra = ["rs_1:group:pla:1", "rs_2:group:tra:1", "rs_3:group:amb:1", "rs_4:group:tpo:1"];
    ...
    mounted() {
        this.lc_token = this.makeToken();
        this.display = (localStorage.getItem('display_fac') == null)? 'table': localStorage.getItem('display_fac');
        this.listen();
        this.coleccion = 'retec_facturas_' + this.indice;
        this.key_history = 'dash_facturas_' + this.indice;
